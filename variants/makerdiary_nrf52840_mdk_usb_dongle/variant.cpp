...
static void selectLfCrystal()
{
	...
	/*
	 * The Makerdiary bootloader leaves LFCLK running from RC. The core's
	 * init() selects LFXO but a running clock ignores that new source, so
	 * stop it before restarting from the board's 32.768 kHz crystal.
	 */
